...
<html>
    <head>
    <meta charset="utf-8">
        <title>SvSoft - Invernadero</title>
        <link href="presentacion/css/invernadero.css" rel="stylesheet" >
...
<body>
<h1 class="Titulos">Datos relevantes del invernadero</h1>
    <br></br>
    <div class="container">
    ...
    <table class="table table-light table-striped table-striped table-hover" style="font-family: sans-serif;">
          ...
          <th class="bg-primary text-white" scope="col">#</th>
		      <th class="bg-secondary text-white" scope="col">Nave</th>
		      <th class="bg-success text-white" scope="col">Temperatura Interna</th>
		      <th class="bg-danger text-white" scope="col">Temperatura Externa</th>
		      <th class="bg-warning text-white" scope="col">Humedad Relativa</th>
			    <th class="bg-info text-white" scope="col">Radiación</th>
		    </tr>
		  </thead>
    </table>
</body>     
